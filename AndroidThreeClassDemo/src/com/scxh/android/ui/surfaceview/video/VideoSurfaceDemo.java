...
public class VideoSurfaceDemo extends Activity implements OnCompletionListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String dataPath = Environment.getExternalStorageDirectory().getPath()
				+ "/voide/test30m.3gp";
		Logs.v("Environment.getExternalStorageDirectory().getPath()>>>>>>>>>>>>:"
	...
	public void surfaceCreated(SurfaceHolder holder) {
		Log.v("Begin:::", "surfaceCreated called");
	...
	public void onPrepared(MediaPlayer player) {
		...
		Logs.v("player >>>>>>>>>>vWidth :"+vWidth+ " vHeight :"+vHeight
				+"\n  currDisplay.getWidth() :"+currDisplay.getWidth()+ " currDisplay.getHeight() :"+currDisplay.getHeight());
