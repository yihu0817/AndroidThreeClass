...
import com.scxh.android.AndroidApliction;
import com.scxh.android.R;
import com.scxh.android.animation.gift.dto.NewGiftDTO;
...
public class GiftActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mApplication = (AndroidApliction) this.getApplicationContext();
		int count = 4;
	...
	public void init() {
		...
		closeButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// 先解决继续Loading的问题
				AndroidApliction.countTime = System.currentTimeMillis();
