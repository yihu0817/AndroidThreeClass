...
public class PullToRefreshView extends ViewGroup {
    ...
    @SuppressLint("NewApi") public PullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    @SuppressLint("NewApi") private void setTargetOffsetTop(int offset, boolean requiresUpdate) {
    ...
    @SuppressLint("NewApi") private boolean canChildScrollUp() {
